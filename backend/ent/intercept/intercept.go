...
// The SchedulingActionFunc type is an adapter to allow the use of ordinary function as a Querier.
type SchedulingActionFunc func(context.Context, *ent.SchedulingActionQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SchedulingActionFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SchedulingActionQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SchedulingActionQuery", q)
}

// The TraverseSchedulingAction type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSchedulingAction func(context.Context, *ent.SchedulingActionQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSchedulingAction) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSchedulingAction) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SchedulingActionQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SchedulingActionQuery", q)
}

// The SchedulingPolicyFunc type is an adapter to allow the use of ordinary function as a Querier.
type SchedulingPolicyFunc func(context.Context, *ent.SchedulingPolicyQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SchedulingPolicyFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SchedulingPolicyQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SchedulingPolicyQuery", q)
}

// The TraverseSchedulingPolicy type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSchedulingPolicy func(context.Context, *ent.SchedulingPolicyQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSchedulingPolicy) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSchedulingPolicy) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SchedulingPolicyQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SchedulingPolicyQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.SchedulingActionQuery:
		return &query[*ent.SchedulingActionQuery, predicate.SchedulingAction, schedulingaction.OrderOption]{typ: ent.TypeSchedulingAction, tq: q}, nil
	case *ent.SchedulingPolicyQuery:
		return &query[*ent.SchedulingPolicyQuery, predicate.SchedulingPolicy, schedulingpolicy.OrderOption]{typ: ent.TypeSchedulingPolicy, tq: q}, nil
