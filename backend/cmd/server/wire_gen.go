...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	schedulingPolicyRepository := repository.NewSchedulingPolicyRepository(client)
	schedulingPolicyService := service.ProvideSchedulingPolicyService(schedulingPolicyRepository, accountRepository, channelMonitorService)
	schedulingPolicyHandler := admin.NewSchedulingPolicyHandler(schedulingPolicyService)
