export default {
    ...
    schedulingPolicies: {
      title: '调度策略',
      description: '根据渠道监控结果自动临停/降级/恢复账号',
      tabPolicies: '策略列表',
      tabActions: '动作历史',
      ...
      failuresSummary: '连续失败 {count} 次',
      latencySummary: '延迟 > {ms}ms',
      pauseSummary: '临停 {minutes} 分钟',
      pauseUntilRecoverySummary: '临停至恢复',
      deprioritizeSummary: '优先级 +{delta}',
      restored: '已恢复',
      active: '生效中',
      noPoliciesYet: '还没有调度策略',
      createFirstPolicy: '创建第一条策略，让监控结果自动驱动账号调度',
      noActionsYet: '还没有调度动作记录',
      noActionsHint: '策略触发或恢复时会在这里留下审计记录',
      loadError: '加载失败',
      createSuccess: '策略创建成功',
      updateSuccess: '策略更新成功',
      deleteSuccess: '策略删除成功',
      deleteConfirm: '确定要删除策略「{name}」吗？此操作不可撤销。',
      monitorRequired: '请选择关联监控',
      ...
      form: {
        ...
        monitor: '关联监控',
        monitorPlaceholder: '选择渠道监控',
        accounts: '目标账号',
        noAccounts: '暂无可选账号',
        consecutiveFailures: '连续失败次数',
        latencyThreshold: '延迟阈值 (ms)',
        latencyThresholdHint: '0 表示不按延迟触发',
        actionType: '触发动作',
        pauseMinutes: '临停时长 (分钟)',
        pauseMinutesHint: '0 表示停用至满足恢复条件（30 天兜底）',
        priorityDelta: '优先级增量',
        priorityDeltaHint: '数值越大优先级越低，恢复时还原原值',
        recoverSuccesses: '恢复所需连续成功次数',
        recoverSuccessesHint: '0 表示不自动恢复，需手动处理',
        cooldownMinutes: '冷却时间 (分钟)',
        cooldownMinutesHint: '两次触发之间的最小间隔，防止频繁抖动',
        enabled: '启用策略'
      }
    },
