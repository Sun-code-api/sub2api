export default {
    ...
    schedulingPolicies: {
      ...
      description: 'Automatically pause / deprioritize / recover accounts based on channel monitor results',
      tabPolicies: 'Policies',
      tabActions: 'Action History',
      searchPlaceholder: 'Search policy name...',
      createButton: 'New Policy',
      createTitle: 'New Scheduling Policy',
      editTitle: 'Edit Scheduling Policy',
      allPolicies: 'All Policies',
      accountsCount: '{count} accounts',
      failuresSummary: '{count} consecutive failures',
      latencySummary: 'latency > {ms}ms',
      pauseSummary: 'Pause {minutes} min',
      pauseUntilRecoverySummary: 'Pause until recovery',
      deprioritizeSummary: 'Priority +{delta}',
      restored: 'Restored',
      active: 'Active',
      noPoliciesYet: 'No scheduling policies yet',
      createFirstPolicy: 'Create your first policy to let monitor results drive account scheduling',
      noActionsYet: 'No scheduling actions yet',
      noActionsHint: 'Trigger and recovery events will be audited here',
      loadError: 'Failed to load',
      createSuccess: 'Policy created',
      updateSuccess: 'Policy updated',
      deleteSuccess: 'Policy deleted',
      deleteConfirm: 'Delete policy "{name}"? This cannot be undone.',
      monitorRequired: 'Please select a monitor',
      ...
      form: {
        ...
        monitor: 'Monitor',
        monitorPlaceholder: 'Select a channel monitor',
        accounts: 'Target Accounts',
        noAccounts: 'No accounts available',
        consecutiveFailures: 'Consecutive Failures',
        latencyThreshold: 'Latency Threshold (ms)',
        latencyThresholdHint: '0 = do not trigger on latency',
        actionType: 'Action',
        pauseMinutes: 'Pause Duration (min)',
        pauseMinutesHint: '0 = pause until recovery condition is met (30-day safety cap)',
        priorityDelta: 'Priority Delta',
        priorityDeltaHint: 'Higher value = lower priority; original value restored on recovery',
        recoverSuccesses: 'Consecutive Successes to Recover',
        recoverSuccessesHint: '0 = no auto recovery, manual handling required',
        cooldownMinutes: 'Cooldown (min)',
        cooldownMinutesHint: 'Minimum interval between triggers to prevent flapping',
