<template>
  ...
  <!-- OpenCode Go icon (terminal prompt) -->
  <svg v-else-if="platform === 'opencode'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
