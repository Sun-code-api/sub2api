...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'opencode' | 'composite'
...
const BADGE: Record<Platform, string> = {
  ...
  opencode: 'bg-teal-500/10 text-teal-600 border-teal-500/30 dark:text-teal-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  opencode: 'bg-teal-500/10 text-teal-600 dark:bg-teal-500/10 dark:text-teal-300',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  opencode: 'border-teal-500/35 dark:border-teal-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  opencode: 'bg-gradient-to-r from-teal-400 to-teal-500',
...
const TEXT: Record<Platform, string> = {
  ...
  opencode: 'text-teal-600 dark:text-teal-400',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  opencode: 'text-teal-500 dark:text-teal-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  opencode: 'bg-teal-600 text-white hover:bg-teal-700 active:bg-teal-800 dark:bg-teal-600/80 dark:hover:bg-teal-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  opencode: 'bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  opencode: 'from-teal-500 to-teal-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'opencode' || p === 'composite'
}
